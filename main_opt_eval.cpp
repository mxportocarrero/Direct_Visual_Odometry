/**
  ...
  g++ main_opt_eval.cpp dataset.cpp -o main_opt_eval `pkg-config opencv --cflags --libs` -O3 -funsafe-math-optimizations -mavx2
  execute with
  ./main_opt_eval > output/main_opt_eval.out
    avg fps = 12
    max fps = 14-15
...
std::vector<const char*> datasets{"data/rgbd_dataset_freiburg01_rpy", // Testing and Debugging Datasets
                         "data/rgbd_dataset_freiburg01_xyz",
                         "data/rgbd_dataset_freiburg02_rpy",
                         "data/rgbd_dataset_freiburg02_xyz",
                         "data/rgbd_dataset_freiburg11_360", // Handheld SLAM
                         "data/rgbd_dataset_freiburg11_floor",
                         "data/rgbd_dataset_freiburg11_desk",
                         "data/rgbd_dataset_freiburg11_desk2",
                         "data/rgbd_dataset_freiburg11_room",
                         "data/rgbd_dataset_freiburg12_360_hemisphere",
                         //"data/rgbd_dataset_freiburg12_360_kidnap", // Este no se usa porque no es una secuencia continua
                         "data/rgbd_dataset_freiburg12_desk",
                         "data/rgbd_dataset_freiburg12_large_no_loop",
                         "data/rgbd_dataset_freiburg12_large_with_loop",
                         "data/rgbd_dataset_freiburg13_long_office_household",
                         "data/rgbd_dataset_freiburg22_pioneer_360", // Robot SLAM
                         "data/rgbd_dataset_freiburg22_pioneer_slam",
                         "data/rgbd_dataset_freiburg22_pioneer_slam2",
                         "data/rgbd_dataset_freiburg22_pioneer_slam3",
                         "data/rgbd_dataset_freiburg33_nostructure_notexture_far", // Structure vs. Texture
                         "data/rgbd_dataset_freiburg33_nostructure_notexture_near_withloop",
                         "data/rgbd_dataset_freiburg33_nostructure_texture_far",
                         "data/rgbd_dataset_freiburg33_nostructure_texture_near_withloop",
                         "data/rgbd_dataset_freiburg33_structure_notexture_far",
                         "data/rgbd_dataset_freiburg33_structure_notexture_near",
                         "data/rgbd_dataset_freiburg33_structure_texture_far",
                         "data/rgbd_dataset_freiburg33_structure_texture_near",
                         "data/rgbd_dataset_freiburg42_desk_with_person", // Dynamic Objects
                         "data/rgbd_dataset_freiburg43_sitting_static",
                         "data/rgbd_dataset_freiburg43_sitting_xyz",
                         "data/rgbd_dataset_freiburg43_sitting_halfsphere",
                         "data/rgbd_dataset_freiburg43_sitting_rpy",
                         "data/rgbd_dataset_freiburg43_walking_static",
                         "data/rgbd_dataset_freiburg43_walking_xyz",
                         "data/rgbd_dataset_freiburg43_walking_halfsphere",
                         "data/rgbd_dataset_freiburg43_walking_rpy"};
...
int main(){
    ...
    //for(const char *x: datasets){
        ...
        std::cout << "-----------------------------------------------------------\n";
            ...
            cv::Mat K = cv::Mat(cv::Size(3,3),CV_32F,k[ std::stoi(filename.substr(27,28))-1 ]); // Ojo que matriz estemos usando!
            ...
            for(int frame=1; frame < myDataset.NoFrames(); ++frame){
                ...
                fout.open(std::string("output/out_fast_")+ filename.substr(18) +std::string(".txt"),std::fstream::app);
                fout.precision(4);
                if(fout.is_open()){
                ...
                fout.open(std::string("output/out_fast_details_")+ filename.substr(18) +std::string(".txt"),std::fstream::app);
                if(frame % 10 == 0){
                    auto end = cv::getTickCount();
                    double time = (end - start) / cv::getTickFrequency();
                    fout << "Mean Process Time per Frame: " << time / 10.0 << " seconds\n";
                    double fps = (1.0 / time) * 10.0;
                    fout << "FPS: " << fps << std::endl;
